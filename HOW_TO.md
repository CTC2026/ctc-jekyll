...
Video clips must be uploaded one at a time. In the VS Code terminal, first make sure you are in the `ctc-jekyll` folder, then run:

**🍎 Mac**
```
cd ~/Documents/ctc-jekyll
wrangler r2 object put ctc-media/assets/plays/mulan/1956-opera-film/Mulan_1956_Clip_1.mp4 \
  --file assets/plays/mulan/1956-opera-film/Mulan_1956_Clip_1.mp4 \
