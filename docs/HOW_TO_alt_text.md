...
### Step 2 — Use Claude Code to suggest alt text

You can describe the image to Claude Code and ask it to suggest alt text:

```
I have an image called Mulan_1956_OperaFilm_1.jpg. It shows the actress 
playing Hua Mulan standing on a stage in traditional opera costume, 
holding a spear, with other performers visible in the background.

Please suggest 2–3 options for alt text for this image, suitable for 
a website about classical Chinese theater.
```

### Step 3 — Review and choose the best option

Read Claude's suggestions and pick the one that is most accurate and informative. Adjust the wording if needed.
