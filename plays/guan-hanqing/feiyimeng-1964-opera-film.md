...
<div class="clip-section">
  <div class="video-wrap">
    <video id="clip3" controls crossorigin="anonymous">
      ...
      <track kind="descriptions" label="Audio Description" src="https://ctc2026.github.io/ctc-jekyll/assets/subtitles/guan-hanqing/feiyimeng-1964-opera-film/Feiyimeng_1964_OperaFilm_Clip_3_audiodesc.vtt">
    </video>
  </div>
  <div class="subtitle-controls" role="group" aria-label="Subtitle language">
    <button class="sub-btn active" data-lang="zh">Chinese</button>
